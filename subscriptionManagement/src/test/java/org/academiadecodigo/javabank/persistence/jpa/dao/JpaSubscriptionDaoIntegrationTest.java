...
import org.academiadecodigo.warpers.persistence.dao.jpa.JpaSubscriptionDao;
...
public class JpaSubscriptionDaoIntegrationTest extends JpaIntegrationTestHelper {

    private final static Integer INVALID_ID = 9999;
    private final static double DOUBLE_DELTA = 0.1;

    private JpaSubscriptionDao accountDao;

    @Before
    public void setup() {

        accountDao = new JpaSubscriptionDao();
        accountDao.setEm(em);
