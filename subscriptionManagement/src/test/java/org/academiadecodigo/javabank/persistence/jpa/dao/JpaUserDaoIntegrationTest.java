...
import org.academiadecodigo.warpers.persistence.dao.jpa.JpaUserDao;
...
public class JpaUserDaoIntegrationTest extends JpaIntegrationTestHelper {

    private final static Integer INVALID_ID = 9999;
    private final static double DOUBLE_DELTA = 0.1;

    private JpaUserDao customerDao;

    @Before
    public void setup() {
        customerDao = new JpaUserDao();
