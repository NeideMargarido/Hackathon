...
import org.academiadecodigo.warpers.services.UserServiceImpl;
...
public class UserServiceImplTest {
    ...
    public void setup() {
        ...
        customerService = new UserServiceImpl();
        customerService.setUserDao(userDao);
        customerService.setRecipientDao(recipientDao);
        customerService.setSubscriptionDao(subscriptionDao);
    }
    ...
    public void testGet() {
        ...
        when(userDao.findById(fakeId)).thenReturn(fakeCustomer);
    ...
    public void testDelete() throws JavaBankException {
        ...
        //verify
        verify(userDao, times(1)).delete(fakeCustomerId);
    ...
    public void testRemoveRecipient() throws JavaBankException {
        ...
        List<Recipient> list = userDao.findById(fakeCustomerId).getRecipients();
    ...
    public void testRemoveRecipientInvalidRecipientOwner() throws JavaBankException {
        ...
        when(recipientDao.findById(fakeRecipientId)).thenReturn(fakeRecipient);
        when(userDao.findById(fakeCustomerIdThatIsTryingToRemove)).thenReturn(fakeCustomer);
    ...
    public void testSave() {
        ...
        when(userDao.saveOrUpdate(fakeCustomer)).thenReturn(fakeCustomer);
    ...
    public void testAddRecipient() throws JavaBankException {
        ...
        when(userDao.findById(fakeCustomerId)).thenReturn(fakeCustomer);
        when(subscriptionDao.findById(fakeRecipient.getAccountNumber())).thenReturn(new SavingsAccount());
    ...
    public void testAddRecipientInvalidAccount() throws JavaBankException {
        ...
        when(userDao.findById(fakeCustomerId)).thenReturn(fakeCustomer);
        when(subscriptionDao.findById(fakeRecipient.getAccountNumber())).thenReturn(null);
    ...
    public void testCloseAccountInvalidAccountOwner() throws JavaBankException {
        ...
        when(subscriptionDao.findById(fakeRecipientId)).thenReturn(fakeAccount);
        when(userDao.findById(fakeCustomerIdThatIsTryingToClose)).thenReturn(fakeCustomer);
